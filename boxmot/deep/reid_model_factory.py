...
__trained_urls = {
    ...
    'lmbn_n_duke.pt':
    'https://github.com/euan-goodbrand/yolov8_tracking/releases/download/v9.0/lmbn_n_duke.pth',
    'lmbn_n_market.pt':
    'https://github.com/euan-goodbrand/yolov8_tracking/releases/download/v9.0/lmbn_n_market.pth',
    'lmbn_n_cuhk03_d.pt':
    'https://github.com/euan-goodbrand/yolov8_tracking/releases/download/v9.0/lmbn_n_cuhk03_d.pth'
}
